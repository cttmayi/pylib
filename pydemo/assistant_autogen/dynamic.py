...
class Configuration(luigi.Task):
    ...
    def output(self):
        ...
        """
        return luigi.LocalTarget('/tmp/Configs_%d.txt' % self.seed)
...
class Data(luigi.Task):
    ...
    def output(self):
        ...
        :rtype: object (:py:class:`luigi.target.Target`)
        """
        return luigi.LocalTarget('/tmp/Datas_%d.txt' % self.magic_number)
...
class Dynamic(luigi.Task):
    ...
    def output(self):
        ...
        :rtype: object (:py:class:`luigi.target.Target`)
        """
        return luigi.LocalTarget('/tmp/Dynamics_%d.txt' % self.seed)
