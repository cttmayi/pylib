...
class ChatGPT:
    ...
    def __init__(self, messages: List[Dict] = None, model: str = "gpt-3.5-turbo", **model_kwargs):
        """
        ...
        self.model_kwargs = dict(model=model)
...
def main():
    """"""
    set_env(title='ChatGPT', output_max_width='1920px')
