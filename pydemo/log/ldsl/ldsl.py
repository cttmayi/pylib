...
_TEMPLATE = '''\
System instruction: LDSL is a DSL for performing actions in PowerPoint.
Here are examples of LDSL’s syntax:
...
Generate an LDSL program to fulfill the given user utterance. Remember to follow the followingrules when generating LDSL:
